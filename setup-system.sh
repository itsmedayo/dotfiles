...
if [ -d "/home/itsme/.ccnet" ]; then
    systemctl_enable_start "seaf-cli@itsme.service"
else
...
ln -sf /etc/pacman.conf /etc/aurutils/pacman-itsme-local.conf
